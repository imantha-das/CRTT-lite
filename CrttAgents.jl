...
mutable struct Resc <: AbstractAgent
    id::Int
    loc_id::Union{Int,Nothing} #id of rescue casualty, pma or hospital
    ...
    function Resc(id;loc_id = nothing, to_impact_zone=true,to_medical=false,at_pma=true,decision=["to_iz","to_pma","to_hosp"], dist_to_loc = 999)
        new(id,loc_id,to_impact_zone,to_medical,at_pma,decision,dist_to_loc)
    end
end
