module AgentTypes
    ...
    mutable struct Cas <: AbstractAgent
        ...
        function Cas(id,ts;status=:awaiting_rescue,rescued_by=999,trans_to_hosp_by=999,at_pma=" ", status_traject=[])
    ...
    mutable struct Resc <: AbstractAgent
        const id::Int
        status::Symbol # :at_iz, :on_way_to_iz, :at_cas, :on_way_to_cas, :at_pma, :load_cas_at_pma, :on_way_to_pma, :at_hosp, :on_way_to_hosp, rescue_finished
        cas_in_rescue::Int
